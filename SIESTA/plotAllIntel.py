...
df_nopt = pd.read_csv("LNCC/noFlagIntel.txt", header = 0, sep='\s+')
df_I = pd.read_csv("LNCC/noFastIntel.txt",header = 0, sep='\s+')
df_II = pd.read_csv("LNCC/fast2Intel.txt", header = 0, sep='\s+')
...
axes.set_title("Comparison of optimatizations - Intel Compiler")
...
#plt.show()
plt.savefig("INTEL-all-LNCC.pdf",dpi=300)